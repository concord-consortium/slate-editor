...
export interface IButtonBaseProps {
  // null results in an empty space in the toolbar
  format: EFormat | EMetaFormat | string | null;
...
export interface IToolbarButtonProps extends IButtonBaseProps {
  iconSize: number;
  buttonSize: number;
}
export const ToolbarButton: React.FC<IToolbarButtonProps> = (props: IToolbarButtonProps) => {
  const {
