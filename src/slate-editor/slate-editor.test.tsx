...
// FIXME: These need to be updated to use the new editor api to get the value.
// describe("Slate Editor", () => {
...
//       expect(slateToText(Editor.value)).toBe(text);
//     });
...
//       render(
//         <>
//           <SlateEditor className="editor-1" />
//           <SlateEditor className="editor-2" />
//         </>);
